...
def upgrade() -> None:
    ...
    # ------------------------------------------------------------------
    op.create_index("ix_organization_id_active", "organization", ["id", "active_to"], schema="meraki")
    op.create_index("ix_network_id_active", "network", ["id", "active_to"], schema="meraki")
    op.create_index("ix_network_org_id", "network", ["organization_id"], schema="meraki")
    op.create_index("ix_device_serial_active", "device", ["serial", "active_to"], schema="meraki")
    op.create_index("ix_device_network_id", "device", ["network_id"], schema="meraki")
    op.create_index("ix_uplink_pk_active", "uplink", ["serial", "interface", "active_to"], schema="meraki")
    op.create_index("ix_dhcp_policy_network_active", "dhcp_server_policy", ["network_id", "active_to"], schema="meraki")
